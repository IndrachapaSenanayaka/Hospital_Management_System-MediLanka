            ...
            <div className="grid-item-3 item-1">
                <div className="scroll-item-1">
                    ...
                    <table className="table">
                        ...
                        <tr>
                            <td className="cent"><Link to={'/staff/admin/update-pharmacist/' + phar._id}><i class='fas fa-edit fa-big fa-green'></i></Link></td>
                            <td className="cent"><Link to={'/staff/admin/delete-pharmacist/' + phar._id}><i class="fa-solid fa-trash-can fa-big fa-red"></i></Link></td>
                        </tr>

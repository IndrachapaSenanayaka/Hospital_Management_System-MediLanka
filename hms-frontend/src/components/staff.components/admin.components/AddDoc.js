...
export default function AddDoc() {
  ...
  const changeOnclick = e => {
    ...
    staff.append("gender", gender);
    staff.append("fname", fname);
    staff.append("lname", lname);
    staff.append("nic", nic);
    staff.append("specialization", specialization);
    staff.append("number", number);
    staff.append("email", email);
    staff.append("password", password);
    staff.append("province", province);
    staff.append("city", city);
    staff.append("street", street);
    staff.append("pcode", pcode);
    staff.append("img", img);

    axios
      .post("http://localhost:8070/staff/addStaff", staff)
      .then(res => {
  ...
  return (
    <div className="grid-container">
      <div className="left-3">
        <img className="DocImg" src={Doc} height="585" alt="DocImg" />
      </div>
            ...
            <form encType="multipart/form-data" name="form1" onSubmit={changeOnclick} className="was-validated" role="form" style={{ padding: "20px 80px 0px 80px;" }} >
              ...
              <ul className="form-style-1">
                ...
                <div className="form-group">
                  ...
                  <input type="file" filename="img" className="form-control" id="exampleFormControlInput1" onChange={(e) => { setImg(e.target.files[0]) }} required />

...
export default function DeleteDoc() {
  ...
  return (
    ...
    <div className='alert'>
      ...
      <div className='back'>
        <Link to={'/staff/admin/view-staff/view-doctor'} className='back'><button className="btn btn-outline-primary"><i class="fas fa-arrow-alt-circle-left"></i>Back</button></Link>
      </div>
    </div>
  );
